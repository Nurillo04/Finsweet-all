...
const cards = document.querySelector(".allPosts__resaults");

const search = document.querySelector(".allPosts__search");
...
search.addEventListener("input", function (e) {
  ...
  if (text === "") {
    ...
    newSearchList = posts.filter(
      (st) =>
        st.firstName.toLowercase().inculdes(text.toLowercase()) ||
        st.lastName.toLowercase().inculdes(text.toLowercase())
    );
  }
  displayPosts(newSearchList);
});
